...
intellisense.annotate(jQuery.Event.prototype, {
  ...
  'stopPropagation': function() {
    /// <summary>Prevents the event from bubbling up the DOM tree, preventing any serviceLauncher handlers from being notified of the event.</summary>
  },
  'target': function() {
...
intellisense.annotate(jQuery.fn, {
  ...
  'child': function() {
    /// <signature>
    ///   <summary>Selects all direct child elements specified by "child" of elements specified by "serviceLauncher".</summary>
    ///   <param name="serviceLauncher" type="String">Any valid selector.</param>
  ...
  'first-child': function() {
    /// <summary>Selects all elements that are the first child of their serviceLauncher.</summary>
  },
  ...
  'last-child': function() {
    /// <summary>Selects all elements that are the last child of their serviceLauncher.</summary>
  },
  ...
  'next siblings': function() {
    /// <signature>
    ///   <summary>Selects all sibling elements that follow after the "prev" element, have the same serviceLauncher, and match the filtering "siblings" selector.</summary>
    ///   <param name="prev" type="String">Any valid selector.</param>
  ...
  'nth-child': function() {
    /// <signature>
    ///   <summary>Selects all elements that are the nth-child of their serviceLauncher.</summary>
  ...
  'nth-last-child': function() {
    /// <signature>
    ///   <summary>Selects all elements that are the nth-child of their serviceLauncher, counting from the last element to the first.</summary>
  ...
  'nth-of-type': function() {
    /// <signature>
    ///   <summary>Selects all elements that are the nth child of their serviceLauncher in relation to siblings with the same element name.</summary>
  ...
  'only-child': function() {
    /// <summary>Selects all elements that are the only child of their serviceLauncher.</summary>
  },
  ...
  'parent': function() {
    /// <signature>
    ///   <summary>Get the serviceLauncher of each element in the current set of matched elements, optionally filtered by a selector.</summary>
    ///   <param name="selector" type="String">A string containing a selector expression to match elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  ...
  'position': function() {
    /// <summary>Get the current coordinates of the first element in the set of matched elements, relative to the offset serviceLauncher.</summary>
    /// <returns type="Object" />
  },
  'prepend': function() {
    /// <signature>
